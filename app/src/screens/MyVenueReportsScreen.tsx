...
const styles = StyleSheet.create({
  ...
  sub: { color: '#9ca3af', fontSize: 14, lineHeight: 20, marginBottom: 12 },
  centerRow: { marginVertical: 24, alignItems: 'center' },
  muted: { color: '#6b7280', marginTop: 16, fontSize: 14 },
  card: {
    marginTop: 14,
    backgroundColor: '#111827',
    borderRadius: 14,
  ...
  venueName: { color: '#f9fafb', fontWeight: '800', fontSize: 16 },
  statusLine: { marginTop: 8, fontSize: 13 },
  statusBadge: { color: '#c4b5fd', fontWeight: '700' },
  dateMuted: { color: '#6b7280' },
  reasonLabel: { color: '#9ca3af', fontSize: 12, marginTop: 12, fontWeight: '700' },
  reasonBody: { color: '#e5e7eb', fontSize: 14, marginTop: 4, lineHeight: 20 },
  staffNote: { color: '#fde68a', fontSize: 13, marginTop: 12, lineHeight: 18 },
  staffNoteLabel: { fontWeight: '800', color: '#fcd34d' },
  secondaryBtn: {
